...
public class MySQLAdapter {
    ...
    public class MySQLConnection {
        ...
        private void executeAsync(Runnable task) {
            Bukkit.getServer().getScheduler().runTaskAsynchronously(SchematicSorter.getInstance(), task);
        }
        ...
        public ResultSet query(String statement, final Object... args) throws SQLException {
            ...
            try {
                ...
                if (e.getMessage().contains("link failure"))
                    SchematicSorter.getInstance().getLogger().warning("[MySQL]: Couldn't connect to MySQL-Server...");
                else
                    throw e;
            }
